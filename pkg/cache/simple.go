...
type SnapshotCache interface {
	...
	GetSnapshot(node string) (*Snapshot, bool)
...
func (cache *snapshotCache) GetNodes() []string {
	nodes := make([]string,0)
	for node, _ := range cache.snapshots {
...
func (cache *snapshotCache) GetSnapshot(node string) (*Snapshot, bool) {
